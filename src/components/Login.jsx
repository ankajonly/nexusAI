            ...
            <div className="auth-container">
                <div className="auth-left">
                    <div className="auth-left-content">
                        ...
                        <div className="auth-brand">
                            <div className="auth-brand-icon">
                                <svg width="36" height="36" viewBox="0 0 28 28" fill="none">
                                    <path d="M14 2L26 8V20L14 26L2 20V8L14 2Z" fill="url(#authLogoGrad)" />
                                    <path d="M14 8L20 11V17L14 20L8 17V11L14 8Z" fill="rgba(255,255,255,0.9)" />
                                    <defs>
                                        <linearGradient id="authLogoGrad" x1="2" y1="2" x2="26" y2="26">
                        ...
                        <p className="auth-subtitle">Sign in to your account to continue building amazing digital experiences.</p>

                        <div className="auth-testimonial">
                            <p className="auth-testimonial-text">
                                "NexusUI helped us launch our product 3x faster. The platform is incredibly intuitive."
                            </p>
                            <div className="auth-testimonial-author">
                                <div className="auth-testimonial-avatar" style={{ background: '#6366f1' }}>AY</div>
                                <div>
